...
func (o *ClusterUninstaller) ListSubnets(c *hwsdk.ServiceClient, opts ListByTagsOptsBuilder) hwpagination.Pager {
	url := c.ServiceURL(c.ProjectID, "subnets")
	if opts != nil {
	...
	return hwpagination.NewPager(c, url, func(r hwpagination.PageResult) hwpagination.Page {
		return hwsubnets.SubnetPage{hwpagination.LinkedPageBase{PageResult: r}}
	})
}
